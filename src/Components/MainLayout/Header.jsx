...
import { MdCorporateFare, MdDesignServices, MdKeyboardArrowDown, MdKeyboardArrowRight, MdOutlineInterpreterMode, MdOutlineRealEstateAgent, MdOutlineRestaurantMenu, MdReadMore } from 'react-icons/md';
...
`}</style>
            <nav className="bg-[#130D1A] sticky top-0 w-full z-[99999] ">
                            ...
                            <div className="grid gap-y-8 lg:flex lg:flex-wrap place-content-start lg:place-content-center h-[100vh] lg:h-[100%] lg:items-center py-4 lg:py-0 ">
                                <ul className='grid gap-y-4  xl:gap-y-6 lg:flex lg:flex-wrap  items-start  text-secondary text-sm md:text-base lg:text-sm lg:gap-x-8 items-center '>
                                    ...
                                    <li className=" lg:block lg:py-8 relative group/outer  hover:text-secondary hover:text-opacity-[0.7] cursor-pointer ">
                                        ...
                                        {/* <div className=" bg-theme lg:bg-dropdownbg lg:shadow-lg rounded-md hidden group-hover/outer:grid lg:absolute left-0 top-full grid grid-cols-1 gap-y-2 lg:!gap-y-6 p-0 md:p-6 lg:p-8 w-full lg:w-[400px] z-50 pt-3 lg:pt-0 pl-4 lg:pl-0">
                                            {serviceMenu.subMenu.map((item, subIndex) => (
                                                <a
                                                    key={subIndex}
                                                    href={item.link}
                                                ...
                                                >
                                                    <div className="flex gap-1 md:gap-2 lg:gap-4 items-center bg-opacity-[0.2] h-[100%] rounded-lg ">
                                                        <p className='text-secondary lg:text-theme text-lg md:text-2xl lg:text-4xl'>{item.icon}</p>
                                                        <div className="">
                                                            <MidTitle className="text-secondary lg:text-primary text-sm !font-normal md:text-base group-hover/inner:underline" text={item.name} />
                                                        </div>
                                                    </div>
                                                </a>
                                            ))}
                                    ...
                                    {/* Portfolio Link */}
                                    <li className='lg:py-8 cursor-pointer text-secondary hover:text-secondary hover:text-opacity-[0.7]'>
                                        <a
                                            href="/portfolio"
                                            className={`font-secondary uppercase ${window.location.pathname === '/portfolio' ? 'text-secondary text-opacity-[0.7]' : ''} `}
                                        >
                                            Portfolio
                                        </a>
                                    </li>
                                    ...
                                    {/* Contact Link */}
                                    <li className=' lg:block hover:text-secondary hover:text-opacity-[0.7]'>
                                        <a
                                            href="/contact"
                                            className={`font-secondary uppercase ${window.location.pathname === '/contact' ? 'text-secondary text-opacity-[0.7]' : ''}  lg:py-8`}
                                        >
                                            Contact
                                        </a>
                                    </li>
