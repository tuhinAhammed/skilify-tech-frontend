...
const PrimaryButton = ({ text, className, slug , icon , disabled}) => {
  ...
  return (
    <div
      ...
      disabled={disabled}
      className={`text-sm lg:text-base text-center px-1 sm:px-2 md:px-5 py-[6px] sm:py-[6px] md:py-[6px] lg:py-3 rounded-full  bg-theme text-secondary hover:bg-buttonHover cursor-pointer
